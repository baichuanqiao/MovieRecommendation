 ...
 * Movie
 */
package com.baichuan.recommender
...
object DataLoader {
  ...
  // 定义常量
  val MOVIE_DATA_PATH = "/Users/baichuanqiao/Downloads/MovieRecommendSystem/recommender/DataLoader/src/main/resources/movies.csv"
  val RATING_DATA_PATH = "/Users/baichuanqiao/Downloads/MovieRecommendSystem/recommender/DataLoader/src/main/resources/ratings.csv"
  val TAG_DATA_PATH = "/Users/baichuanqiao/Downloads/MovieRecommendSystem/recommender/DataLoader/src/main/resources/tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = Map(
      "spark.cores" -> "local[*]",
      "mongo.uri" -> "mongodb://192.168.242.5:27017/recommender",
      "mongo.db" -> "recommender",
      "es.httpHosts" -> "192.168.242.5:9200",
      "es.transportHosts" -> "192.168.242.5:9300",
